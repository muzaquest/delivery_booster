...
Этот день провалился из‑за сочетания реклама и операции на кухне/доставке.

ТОП‑факторы (по категориям):
| Категория | Показатель | Влияние | Приоритет | Комментарий |
|---|---|---:|---|---|
| Marketing | ROAS (GRAB) | ▼ 46.6% █████████ | 🔴 критично | реклама GRAB неэффективна (9.26x vs 13.84x) |
| Operations | GOJEK: время приготовления | ▼ 10.9% ██ | 🟠 важно | время приготовления выше нормы (15.1 vs 16.6 мин) |

Что помогло (до 2 факторов):
| Категория | Показатель | Влияние | Комментарий |
|---|---|---:|---|
| Operations | Среднее время подтверждения (мин) | ▲ 4.3% █ | подтверждение быстрее обычного (0.0 vs 0.0 мин) |

Рекомендации (рычаги и эффект):
- Увеличить бюджет на работающие кампании (+10%): ≈ 41 411 IDR ✅ High
- Сократить SLA (−10% к приготовлению/подтверждению/доставке): ≈ -2 658 IDR 🟠 High
- Исключить оффлайн на платформах: ≈ 3 503 IDR 🟢 Medium
