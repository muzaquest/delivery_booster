...
🚀 ПЛАН ДЕЙСТВИЙ:
🔴 КРИТИЧНО (48 часов):
  1. Праздничная стратегия (Eid al-Fitr, Nyepi) → +18.2M IDR/квартал
  2. Увеличение рекламы в праздники на 50-100% → +12.8M IDR

🟡 ВАЖНО (2 недели):  
  3. Таргетинг немусульман/туристов в религиозные праздники → +8.4M IDR
  4. Upsell стратегия (промо >400K IDR) → +11.3M IDR

📈 ROADMAP (3 квартала):
  • Q3 2025: праздничная оптимизация → 1 150M IDR (+6.4%)
  • Q4 2025: сезонные стратегии → 1 280M IDR (+18.4%)  
  • Q1 2026: полная автоматизация → 1 420M IDR (+31.4%)

🎯 ГЛАВНАЯ РЕКОМЕНДАЦИЯ:
Разработать комплексную стратегию работы в праздничные дни с учетом 
мусульманских, балийских и международных праздников.
