...
```
📊 EXECUTIVE DASHBOARD — АНАЛИЗ СЕТИ РЕСТОРАНОВ
════════════════════════════════════════════════════════════════════════════════
Период: июнь-июль 2025 | Источник: Live API | 47 ресторанов
Обновлено: 2025-08-15 14:30 UTC

🎯 ИСПОЛНИТЕЛЬНОЕ РЕЗЮМЕ
💰 Выручка сети: 6.00B IDR за 2 месяца (+10.9% MoM)
📦 Общие заказы: 27 140 (+11.3% MoM)  
💵 Средний чек: 221K IDR (-0.3% MoM, требует внимания)
🎯 Общий ROAS: 19.1x (отличная эффективность)
🚨 Критических ресторанов: 8 из 47 (17% сети)

📈 КЛЮЧЕВЫЕ ТРЕНДЫ
┌─ 🟢 РАСТУЩИЕ ПОКАЗАТЕЛИ
│  ├─ Выручка: +10.9% MoM (+309.5M IDR)
│  ├─ Заказы: +11.3% MoM (+1 446 заказов)
│  ├─ ROAS: +3.7% (с 18.7x до 19.4x)
│  └─ MER: +0.9% пункта (эффективность рекламы)
│
└─ 🔴 ПАДАЮЩИЕ ПОКАЗАТЕЛИ
   ├─ Средний чек: -0.3% MoM (-651 IDR)
   ├─ Конверсия GRAB: -2.1% (проблема платформы)
   └─ Рейтинг Seminyak: -0.2 пункта (качество сервиса)
